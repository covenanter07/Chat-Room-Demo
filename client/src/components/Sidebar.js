    ...
    <div className="w-full h-full grid grid-cols-[48px,1fr] bg-white">
      ...
      <div className="w-full">
        <div className="h-16 flex items-center">
          <h2 className="text-x1 font-bold p-4 text-slate-800">Message</h2>
        </div>
        ...
        <div className="h-[calc(100vh-65px)] overflow-x-hidden overflow-y-auto scrollbar">
          {allUser.length === 0 && (
            <div className="mt-12">
              <div className="flex justify-center center my-4 text-slate-500">
                <RiArrowLeftUpFill size={50} />
              </div>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {conv?.lastMsg?.pdfUrl && (
                        <div className="flex items-center gap-1">
                          ...
                          {!conv?.lastMsg?.text && <span>PDF</span>}
                        </div>
                      )}
